...
var infrastructuresResource = schema.GroupVersionResource{Group: "config.uccp.io", Version: "v1", Resource: "infrastructures"}

var infrastructuresKind = schema.GroupVersionKind{Group: "config.uccp.io", Version: "v1", Kind: "Infrastructure"}
