...
var proxiesResource = schema.GroupVersionResource{Group: "config.uccp.io", Version: "v1", Resource: "proxies"}

var proxiesKind = schema.GroupVersionKind{Group: "config.uccp.io", Version: "v1", Kind: "Proxy"}
