...
var schedulersResource = schema.GroupVersionResource{Group: "config.uccp.io", Version: "v1", Resource: "schedulers"}

var schedulersKind = schema.GroupVersionKind{Group: "config.uccp.io", Version: "v1", Kind: "Scheduler"}
