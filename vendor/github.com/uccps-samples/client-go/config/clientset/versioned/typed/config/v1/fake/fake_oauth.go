...
var oauthsResource = schema.GroupVersionResource{Group: "config.uccp.io", Version: "v1", Resource: "oauths"}

var oauthsKind = schema.GroupVersionKind{Group: "config.uccp.io", Version: "v1", Kind: "OAuth"}
