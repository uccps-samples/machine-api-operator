...
var apiserversResource = schema.GroupVersionResource{Group: "config.uccp.io", Version: "v1", Resource: "apiservers"}

var apiserversKind = schema.GroupVersionKind{Group: "config.uccp.io", Version: "v1", Kind: "APIServer"}
