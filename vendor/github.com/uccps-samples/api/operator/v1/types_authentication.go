...
type AuthenticationStatus struct {
	...
	// Note that this field will be removed in the future releases, once https://github.com/uccps-samples/enhancements/blob/master/enhancements/authentication/separate-oauth-resources.md is fully implemented
	// +optional
